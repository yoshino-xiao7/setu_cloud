 ...
 * 2.2 按作品 ID 抓取
 */
export function crawlByIds(data: CrawlByIdsRequest) {
 ...
 * 2.3 按作者抓取
 */
export function crawlByUser(userId: string | number, skipExisting: boolean = true) {
 ...
 * 2.4 按标签抓取
 */
export function crawlByTag(data: CrawlByTagRequest) {
 ...
 * 2.5 获取任务列表
 */
export function fetchCrawlerTasks(params?: FetchCrawlerTasksParams) {
 ...
 * 2.6 查询任务详情
 */
export function fetchCrawlerTask(taskId: string) {
 ...
 * 2.7 取消任务
 */
export function cancelCrawlerTask(taskId: string) {
